...
public class Tabla_de_clientesController extends LoginController implements Initializable {
    ...
    private ObservableList<clientes> Clientesd;
    /**
     * Initializes the controller class.
     */
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        Clientesd  = FXCollections.observableArrayList();
        this.Tabla_clientes.setItems(Clientesd);
        ...
        try{
            ...
            while(result.next()){
                ...
                if(!this.Clientesd.contains(c)){
                    this.Clientesd.add(c);
                    this.Tabla_clientes.setItems(Clientesd);
                }
            }
            ps.close();
    ...
    public void agregar_cliente(ActionEvent event){
        try{
            ...
            controller.initAttributes(Clientesd);
    ...
    public void editar_cliente(ActionEvent event){
        ...
        if(c != null){
            try{
                ...
                controller.initAttributes(Clientesd,c);
                Stage stage = new Stage();
                stage.initModality(Modality.APPLICATION_MODAL);
                stage.setScene(scene);
                stage.setResizable(false);
